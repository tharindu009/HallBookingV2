...
$(document).ready(function () {
	...
	var stickyToggle = function (sticky, stickyWrapper, scrollElement) {
		...
		if (scrollElement.scrollTop() >= stickyTop) {
			...
			var logoimg_ = document.getElementById("logoimg");
			logoimg_.style.marginLeft = '125px';

			var navbar_ = document.getElementById("menuui");
			navbar_.style.marginRight = '125px';
			...
			var logoimg_ = document.getElementById("logoimg");
			logoimg_.style.marginLeft = '0px';

			var navbar_ = document.getElementById("menuui");
			navbar_.style.marginRight = '0px';
		}
	};
