<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signin.aspx.cs" Inherits="HallBookingV2.signin" %>
...
<head>
	...
	<title>Place Finder | Sign In</title>
				...
				<div class="hero-wrapper">
					...
					<div class="main-navigation">
						<div class="container">
							...
							<!--end navbar-->
							<ol class="breadcrumb">
								<li class="breadcrumb-item"><a href="defailt.aspx">Home</a></li>
					...
					<div class="page-title">
						<div class="container">
							<h1 style="margin-bottom:-20px;margin-top:-20px">Sign In</h1>
						</div>
						<!--end container-->
					</div>
					<!--============ End Page Title =====================================================================-->
							...
							<div class="col-md-4">
								<div class="form clearfix">
									...
									Remember Me
										...
										<asp:Button ID="btnSignIn" CssClass="btn btn-primary small" runat="server" Text="Sign In" OnClick="btnSignIn_Click" />
								...
								<hr>
								<p>
									<a style="margin-right: 10%" href="forgetpassword.aspx" class="link">Forgot password?</a><a style="margin-right: 10%" href="register.aspx" class="link">Sign up</a><a href="#" class="link">Add venue</a>
								</p>
							</div>
							<!--end col-md-6-->
						</div>
