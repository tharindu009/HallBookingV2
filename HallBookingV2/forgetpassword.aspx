<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forgetpassword.aspx.cs" Inherits="HallBookingV2.forgetpassword" %>
...
<head>
	...
	<title>Place Finder | Forget Password</title>
						...
						<div class="container">
							<nav class="navbar navbar-expand-lg navbar-light justify-content-between top-navbar" data-toggle="sticky-onscroll">
								<a class="navbar-brand" href="default.aspx">
									<img src="assets/img/logo1.png" alt="place finder logo" id="logoimg">
								</a>
							...
							<div class="col-md-4">
								<div class="form clearfix">
									<div class="form-group">
										...
										<asp:TextBox ID="txtUserName" CssClass="form-control small" placeholder="Your Email" runat="server" required></asp:TextBox>
									...
									<div class="d-flex justify-content-between align-items-baseline">
										<asp:UpdatePanel ID="UpdatePanel1" runat="server">
											<ContentTemplate>
												<asp:Button ID="btnSend" CssClass="btn btn-primary small" runat="server" Text="Send reset link" OnClick="btnSend_Click" />
		...
		<script type="text/javascript">
			...
			function added() {
				swal(
					{
						title: 'Hello!',
						text: 'We have sent you an email to your email address to reset your password. Please check your inbox or junk folder in few minutes.',
						type: 'success',
						icon: "success",
						button: "Login Now!",
			...
			function notreg() {
				swal(
					{
						title: 'Sorry!',
						text: 'The email address you have entered is not a registered email.',
						type: 'info',
						icon: "info",
						button: "Register now!",
						confirmButtonColor: '#4fa7f3'
