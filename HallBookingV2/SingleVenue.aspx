<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SingleVenue.aspx.cs" Inherits="HallBookingV2.SingleVenue" %>
						...
						<div class="row">
							...
							<div class="col-md-9">
								...
								<section>
									...
									<div class="gallery-carousel owl-carousel">
										<asp:Repeater ID="Repeater2" runat="server">
											<ItemTemplate>
												<img src="<%#Eval("Image") %>" alt="" data-hash="<%#Eval("ID") %>">
											</ItemTemplate>
										</asp:Repeater>
								...
								<section>
									<div class="row">
										...
										<div class="col-md-8">
											...
											<div class="map height-200px" id="map-small"></div>
										</div>
									</div>
								</section>
								...
								<section>
									...
									<div class="row">
										<div class="col-md-2">
											...
											<asp:Label ID="lblSeminar" class="col-form-label" runat="server" Text="-"></asp:Label>
										</div>
										<div class="col-md-2">
											<figure class="category-icon">
												<span>
											...
											<asp:Label ID="lblTheater" class="col-form-label" runat="server" Text="-"></asp:Label>
										</div>
										<div class="col-md-2">
											<figure class="category-icon">
												<span>
											...
											<asp:Label ID="lblBanquet" class="col-form-label" runat="server" Text="-"></asp:Label>
										</div>
										<div class="col-md-3">
											<figure class="category-icon">
												<span>
											...
											<asp:Label ID="lblConference" runat="server" Text="-"></asp:Label>
										</div>
										<div class="col-md-3">
								...
								<section>
									...
									<div class="row">
										<div class="col-md-3">
											<asp:Label ID="lblPricePer" class="col-form-label" runat="server" Text="-"></asp:Label>
											<p><strong>Price / Person</strong></p>
										</div>
										<div class="col-md-3">
											<asp:Label ID="lblPricePla" class="col-form-label" runat="server" Text="-"></asp:Label>
											<p><strong>Price / Plate</strong></p>
										</div>
										<div class="col-md-3">
											<asp:Label ID="lblRentHour" class="col-form-label" runat="server" Text="-"></asp:Label>
											<p><strong>Rent / Hour</strong></p>
										</div>
										<div class="col-md-3">
											<asp:Label ID="lblRentDay" class="col-form-label" runat="server" Text="-"></asp:Label>
								...
								<section>
									...
									<div class="row">
										<div class="col-md-3">
											...
											<asp:Label ID="lblDeposit" class="col-form-label" runat="server" Text="-"></asp:Label>
										</div>
										<div class="col-md-12">
										...
										<div class="items compact">
											...
											<div class="item">
												<div class="wrapper">
													...
													<br />
													<asp:Button ID="Button1" CssClass="btn btn-warning small" Style="margin-left: 10px; margin-bottom: 10px; width: 90%" runat="server" Text="Send Inquiry" />
													<!--end meta-->
												</div>
											</div>
											<!--end item-->
					...
					<div class="row">
						...
						<div class="col-md-4">
							...
							<address>
								...
								<br>
								<strong>Email:</strong> <a href="#">info@placefinder</a>
								<br>
